 ...
 * 
 * Common capabilities, features, and usage tiers shared across all minimax models.
...
/** Helper to create a minimax model with defaults */
export function withMinimaxDefaults<T extends object>(model: T): T & {
