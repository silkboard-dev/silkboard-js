 ...
 * 
 * Common capabilities, features, and usage tiers shared across all azure models.
...
/** Helper to create a azure model with defaults */
export function withAzureDefaults<T extends object>(model: T): T & {
