/**
 * DeepSeek V3.2 (via Chutes)
 *
 * chutes model: deepseek-ai/DeepSeek-V3.2
 */
...
const deepseek_v3_2: ModelDefinition = withChutesDefaults(defineModel({
  id: 'deepseek-ai/DeepSeek-V3.2',
  name: 'DeepSeek V3.2',
  type: 'chat',
  family: 'chutes',
  status: 'ga',
  description: 'DeepSeek V3.2 served via Chutes llm gateway.',
  contextWindow: {
