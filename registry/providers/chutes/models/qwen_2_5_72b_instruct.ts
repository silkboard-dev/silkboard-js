/**
 * Qwen2.5 72B Instruct (via Chutes)
 *
 * chutes model: Qwen/Qwen2.5-72B-Instruct
 */
...
const qwen_2_5_72b_instruct: ModelDefinition = withChutesDefaults(defineModel({
  id: 'Qwen/Qwen2.5-72B-Instruct',
  name: 'Qwen2.5 72B Instruct',
  type: 'chat',
  family: 'chutes',
  status: 'ga',
  description: 'Qwen2.5 72B Instruct served via Chutes llm gateway.',
  contextWindow: {
