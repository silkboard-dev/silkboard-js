/**
 * DeepSeek V3.2 Speciale (via Chutes)
 *
 * chutes model: deepseek-ai/DeepSeek-V3.2-Speciale
 */
...
const deepseek_v3_2_speciale: ModelDefinition = withChutesDefaults(defineModel({
  id: 'deepseek-ai/DeepSeek-V3.2-Speciale',
  name: 'DeepSeek V3.2 Speciale',
  type: 'chat',
  family: 'chutes',
  status: 'ga',
  description: 'DeepSeek V3.2 Speciale served via Chutes llm gateway.',
  contextWindow: {
...
export default deepseek_v3_2_speciale;
