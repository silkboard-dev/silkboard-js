 ...
 *
 * Large multimodal Qwen2.5 vision-language model.
 *
 * @see {@link https://app.fireworks.ai/models/fireworks/qwen2p5-vl-72b-instruct}
...
const accounts_fireworks_models_qwen2p5_vl_72b_instruct: ModelDefinition = withFireworksDefaults(
  defineModel({
...
export default accounts_fireworks_models_qwen2p5_vl_72b_instruct;
