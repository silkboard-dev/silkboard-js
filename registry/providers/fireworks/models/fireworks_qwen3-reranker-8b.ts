 ...
 * Qwen3 Reranker 8B
 *
 * Large Qwen3 reranker model for document reranking.
 *
...
const fireworks_qwen3_reranker_8b: ModelDefinition = withFireworksDefaults(
  defineModel({
...
export default fireworks_qwen3_reranker_8b;
