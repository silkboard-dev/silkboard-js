 ...
 *
 * General-purpose Qwen2.5 32B instruct model.
 *
 * @see {@link https://fireworks.ai/models/fireworks/qwen2p5-32b-instruct}
 */
...
const accounts_fireworks_models_qwen2p5_32b_instruct: ModelDefinition = withFireworksDefaults(
  defineModel({
...
export default accounts_fireworks_models_qwen2p5_32b_instruct;
