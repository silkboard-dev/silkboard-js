 ...
 * 
 * fireworks model: accounts/fireworks/models/llama-v3p1-70b-instruct
 * 
...
const accounts_fireworks_models_llama_v3p1_70b_instruct: ModelDefinition = withFireworksDefaults(defineModel({
...
export default accounts_fireworks_models_llama_v3p1_70b_instruct;
