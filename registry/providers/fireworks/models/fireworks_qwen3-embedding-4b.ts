 ...
 * Qwen3 Embedding 4B
 *
 * Medium Qwen3 embeddings model on Fireworks.
 *
...
const fireworks_qwen3_embedding_4b: ModelDefinition = withFireworksDefaults(
  defineModel({
...
export default fireworks_qwen3_embedding_4b;
