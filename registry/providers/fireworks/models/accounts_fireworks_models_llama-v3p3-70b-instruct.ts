...
const accounts_fireworks_models_llama_v3p3_70b_instruct: ModelDefinition = withFireworksDefaults(defineModel({
...
export default accounts_fireworks_models_llama_v3p3_70b_instruct;
