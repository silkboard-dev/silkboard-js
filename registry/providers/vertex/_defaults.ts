/**
 * vertex Provider Defaults
 * 
 * Common capabilities, features, and usage tiers shared across all vertex models.
...
/** Helper to create a vertex model with defaults */
export function withVertexDefaults<T extends object>(model: T): T & {
