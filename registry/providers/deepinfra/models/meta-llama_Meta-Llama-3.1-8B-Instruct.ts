 ...
 * 
 * deepinfra model: meta-llama/Meta-Llama-3.1-8B-Instruct
 * 
...
const meta_llama_Meta_Llama_3_1_8B_Instruct: ModelDefinition = withDeepinfraDefaults(defineModel({
...
export default meta_llama_Meta_Llama_3_1_8B_Instruct;
