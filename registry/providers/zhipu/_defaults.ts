/**
 * zhipu Provider Defaults
 * 
 * Common capabilities, features, and usage tiers shared across all zhipu models.
...
/** Default capabilities for zhipu models */
...
/** Helper to create a zhipu model with defaults */
export function withZhipuDefaults<T extends object>(model: T): T & {
