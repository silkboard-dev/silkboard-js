 ...
 * 
 * Common capabilities, features, and usage tiers shared across all bedrock models.
...
/** Helper to create a bedrock model with defaults */
export function withBedrockDefaults<T extends object>(model: T): T & {
