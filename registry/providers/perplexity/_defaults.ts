 ...
 * 
 * Common capabilities, features, and usage tiers shared across all perplexity models.
...
/** Default capabilities for perplexity models */
...
/** Default features for perplexity models */
...
/** Usage tiers (rate limits) for perplexity */
...
/** Helper to create a perplexity model with defaults */
export function withPerplexityDefaults<T extends object>(model: T): T & {
